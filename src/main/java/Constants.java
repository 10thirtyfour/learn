...
/**
 * Created by artemk on 11/16/15.
 */
public final class Constants {
    public static final String CHARACTER_NAME = "TestName";
    public static final String ATTRIBUTE_NAME1 = "TestAttribute1";
    public static final String ATTRIBUTE_NAME2 = "TestAttribute2";
    public static final String ATTRIBUTE_NAME3 = "TestAttribute3";
